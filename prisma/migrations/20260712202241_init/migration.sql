...
CREATE TABLE "neighborhood_fees" (
    ...
    CONSTRAINT "neighborhood_fees_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "products_available_featured_idx" ON "products"("available", "featured");

-- CreateIndex
CREATE INDEX "products_available_promotion_idx" ON "products"("available", "promotion");
...
-- AddForeignKey
ALTER TABLE "neighborhood_fees" ADD CONSTRAINT "neighborhood_fees_deliveryAreaId_fkey" FOREIGN KEY ("deliveryAreaId") REFERENCES "delivery_areas"("id") ON DELETE CASCADE ON UPDATE CASCADE;
